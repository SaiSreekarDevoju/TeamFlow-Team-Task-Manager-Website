...
import { n as require_react_is$1, t as invariant$1 } from "./tiny-invariant-CPdcA7-h.js";
...
var getDragImpact = (({ pageOffset, draggable, draggables, droppables, previousImpact, viewport, afterCritical }) => {
	...
	if (!destinationId) return noImpact$1;
...
var pendingDrop = (store) => (next) => (action) => {
	...
	store.dispatch(drop$1({ reason: postActionState.reason }));
};
...
var useLayoutEffect = typeof window !== "undefined" && typeof window.document !== "undefined" && typeof window.document.createElement !== "undefined" ? import_react.useLayoutEffect : import_react.useEffect;
var getHead = () => {
...
function useRegistry() {
	...
	(0, import_react.useEffect)(() => {
		return function unmount() {
			if (import_react.version.startsWith("16") || import_react.version.startsWith("17")) requestAnimationFrame(registry.clean);
			else registry.clean();
		};
	}, [registry]);
	return registry;
...
var useUniqueId$1 = "useId" in import_react.default ? useUniqueId : useDeprecatedUniqueId;
function getElementId({ contextId, uniqueId }) {
	return `rfd-hidden-text-${contextId}-${uniqueId}`;
}
function useHiddenTextElement({ contextId, text }) {
	const uniqueId = useUniqueId$1("hidden-text", { separator: "-" });
...
var supportedPageVisibilityEventName = (() => {
...
var createResponders = (props) => ({
	onBeforeCapture: (t) => {
		...
		if (import_react.version.startsWith("16") || import_react.version.startsWith("17")) onBeforeCapureCallback();
		else (0, import_react_dom.flushSync)(onBeforeCapureCallback);
	},
...
var useUniqueContextId$1 = "useId" in import_react.default ? useUniqueContextId : useDeprecatedUniqueContextId;
...
var Draggable = (props) => {
	...
	const onMoveEnd = useCallback((event) => {
		...
		if (import_react.version.startsWith("16") || import_react.version.startsWith("17")) dropAnimationFinishedAction();
		else (0, import_react_dom.flushSync)(dropAnimationFinishedAction);
...
var ConnectedDraggable$1 = connect(makeMapStateToProps$1, { dropAnimationFinished }, null, {
	context: StoreContext,
	areStatePropsEqual: isStrictEqual
})(Draggable$1);
function PrivateDraggable(props) {
	if (useRequiredContext(DroppableContext).isUsingCloneFor === props.draggableId && !props.isClone) return null;
	return import_react.createElement(ConnectedDraggable$1, props);
}
...
var ConnectedDroppable$1 = connect(makeMapStateToProps, { updateViewportMaxScroll }, (stateProps, dispatchProps, ownProps) => {
	return {
